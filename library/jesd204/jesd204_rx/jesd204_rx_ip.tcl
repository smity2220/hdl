...
adi_add_bus "rx_cfg" "slave" \
  "ADI:user:jesd204_rx_cfg_rtl:1.0" \
  "ADI:user:jesd204_rx_cfg:1.0" \
  { \
...
adi_add_bus "rx_status" "master" \
  "ADI:user:jesd204_rx_status_rtl:1.0" \
  "ADI:user:jesd204_rx_status:1.0" \
  { \
...
adi_add_bus "rx_ilas_config" "master" \
  "ADI:user:jesd204_rx_ilas_config_rtl:1.0" \
  "ADI:user:jesd204_rx_ilas_config:1.0" \
  { \
...
adi_add_bus "rx_event" "master" \
  "ADI:user:jesd204_rx_event_rtl:1.0" \
  "ADI:user:jesd204_rx_event:1.0" \
  { \
