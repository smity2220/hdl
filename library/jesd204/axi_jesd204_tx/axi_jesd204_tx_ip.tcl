...
adi_add_bus "tx_cfg" "master" \
  "ADI:user:jesd204_tx_cfg_rtl:1.0" \
  "ADI:user:jesd204_tx_cfg:1.0" \
  { \
...
adi_add_bus "tx_ilas_config" "slave" \
  "ADI:user:jesd204_tx_ilas_config_rtl:1.0" \
  "ADI:user:jesd204_tx_ilas_config:1.0" \
  { \
...
adi_add_bus "tx_event" "slave" \
  "ADI:user:jesd204_tx_event_rtl:1.0" \
  "ADI:user:jesd204_tx_event:1.0" \
  { \
...
adi_add_bus "tx_status" "slave" \
  "ADI:user:jesd204_tx_status_rtl:1.0" \
  "ADI:user:jesd204_tx_status:1.0" \
  { \
...
adi_add_bus "tx_ctrl" "master" \
  "ADI:user:jesd204_tx_ctrl_rtl:1.0" \
  "ADI:user:jesd204_tx_ctrl:1.0" \
  { \
